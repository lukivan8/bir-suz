    ...
    >
      <div>
        ...
        <p class="modal-note">
          ...
          даже при выключенной аналитике. В закрытой панели доверенной команды
          видны псевдоним установки и дата подключения к организации; при
          разрешённой аналитике — также дата последнего выполненного задания.
          Адреса страниц, содержимое сайтов, формы, cookies и ваши личные слова
