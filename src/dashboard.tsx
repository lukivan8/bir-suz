        ...
        <div class="settings-toggle-row">
          <div>
            ...
            <p>
              ...
              идентификатором установки. Для организации публично видны общие
              показатели и дата последнего задания рядом с псевдонимом.
              Выключение очищает текущую очередь, но не удаляет данные с
              сервера. Адреса страниц, содержимое сайтов и личные слова не
              отправляются.{' '}
              <a
                href="https://api.lukivan8.com/privacy"
                target="_blank"
